...
INSERT INTO Student_Grade (Student_id, School_id, Program_id, Form_nb, Effective_dt, Notes_tx, Deleted_yn, Version_nb)
SELECT G.Student_id, S.School_id, 1 AS Program_id, G.Form_nb, G.Effective_dt, G.Notes_tx, 'N' AS Deleted_yn, 1 AS Version_nb
FROM GradeLevel G
INNER JOIN School S ON (G.School_tx = S.School_nm);
DROP TABLE GradeLevel;
go
